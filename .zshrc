...
POWERLEVEL9K_CUSTOM_POMODORO_BACKGROUND="black"
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(background_jobs status custom_internet_signal custom_ip disk_usage os_icon)
...
plugins=(git osx common-aliases encode64 gulp history jira jsontools vi-mode emoji scala sbt zsh-syntax-highlighting history-substring-search zsh-syntax-highlighting git-open stime)
