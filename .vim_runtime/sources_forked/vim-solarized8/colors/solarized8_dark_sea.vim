...
let colors_name = "solarized8_dark_sea"

if !has('gui_running') && get(g:, 'solarized_termtrans', 0)
  hi! Normal cterm=NONE gui=NONE ctermfg=12 guifg=#ded3be ctermbg=NONE guibg=NONE
else
  hi! Normal cterm=NONE gui=NONE ctermfg=12 guifg=#ded3be ctermbg=8 guibg=#002b36
endif
hi! LineNr cterm=NONE gui=NONE ctermfg=10 guifg=#ded3be ctermbg=NONE guibg=NONE
hi! CursorLineNr ctermbg=NONE guibg=NONE
hi! Folded cterm=NONE,bold gui=NONE,bold ctermfg=12 guifg=#8fa1af ctermbg=NONE guibg=NONE guisp=#002b36
hi! FoldColumn cterm=NONE gui=NONE ctermfg=12 guifg=#8fa1af ctermbg=NONE guibg=NONE
hi! Comment cterm=NONE gui=NONE,italic ctermfg=10 guifg=#ded3be ctermbg=NONE guibg=NONE
hi! Constant cterm=NONE gui=NONE ctermfg=6 guifg=#d75d29 ctermbg=NONE guibg=NONE
hi! Identifier cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! Statement cterm=NONE gui=NONE ctermfg=2 guifg=#0084a1 ctermbg=NONE guibg=NONE
hi! PreProc cterm=NONE gui=NONE ctermfg=9 guifg=#fea636 ctermbg=NONE guibg=NONE
hi! Type cterm=NONE gui=NONE ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
hi! Special cterm=NONE gui=NONE ctermfg=9 guifg=#00c5c7 ctermbg=NONE guibg=NONE
...
hi! Cursor cterm=NONE gui=NONE ctermfg=15 guifg=#fdf6e3 ctermbg=4 guibg=#009dba
if get(g:, "solarized_visibility", "") == "high"
  ...
  hi! Title cterm=NONE,bold gui=NONE,bold ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
...
hi! Directory cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! ErrorMsg cterm=NONE,reverse gui=NONE,reverse ctermfg=1 guifg=#d75d29 ctermbg=15 guibg=#fdf6e3
hi! IncSearch cterm=NONE,standout gui=NONE,standout ctermfg=9 guifg=#d98f7f ctermbg=NONE guibg=NONE
hi! Search cterm=NONE,reverse gui=NONE,reverse ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
hi! MoreMsg cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! ModeMsg cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! Question cterm=NONE,bold gui=NONE,bold ctermfg=6 guifg=#00c5c7 ctermbg=NONE guibg=NONE
...
hi! WildMenu ctermfg=11 guifg=#23526b ctermbg=7 guibg=#ded3be cterm=NONE,reverse gui=NONE,reverse
if get(g:, "solarized_diffmode", "") == "high"
  hi! DiffAdd cterm=NONE,reverse gui=NONE,reverse ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE
  hi! DiffChange cterm=NONE,reverse gui=NONE,reverse ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
  hi! DiffDelete cterm=NONE,reverse gui=NONE,reverse ctermfg=1 guifg=#dc322f ctermbg=NONE guibg=NONE
  hi! DiffText cterm=NONE,reverse gui=NONE,reverse ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
elseif get(g:, "solarized_diffmode", "") == "low"
  hi! DiffAdd cterm=NONE gui=NONE ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE guisp=#8c9d00
  hi! DiffChange cterm=NONE gui=NONE ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE guisp=#fea636
  hi! DiffDelete cterm=NONE,bold gui=NONE,bold ctermfg=1 guifg=#dc322f ctermbg=NONE guibg=NONE
  hi! DiffText cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE guisp=#009dba
elseif get(g:, "solarized_diffmode", "") == "bold"
    hi! DiffAdd cterm=NONE,bold gui=NONE,bold ctermfg=2 guifg=#8c9d00 ctermbg=0 guibg=#073642 guisp=#8c9d00
    hi! DiffChange cterm=NONE,bold gui=NONE,bold ctermfg=3 guifg=#fea636 ctermbg=0 guibg=#073642 guisp=#fea636
    hi! DiffDelete cterm=NONE,bold gui=NONE,bold ctermfg=1 guifg=#dc322f ctermbg=0 guibg=#073642
    hi! DiffText cterm=NONE,bold gui=NONE,bold ctermfg=4 guifg=#009dba ctermbg=0 guibg=#073642 guisp=#009dba
else
  hi! DiffAdd cterm=NONE gui=NONE ctermfg=2 guifg=#8c9d00 ctermbg=0 guibg=#073642 guisp=#8c9d00
  hi! DiffChange cterm=NONE gui=NONE ctermfg=3 guifg=#fea636 ctermbg=0 guibg=#073642 guisp=#fea636
  hi! DiffDelete cterm=NONE gui=NONE ctermfg=1 guifg=#dc322f ctermbg=0 guibg=#073642
  hi! DiffText cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=0 guibg=#073642 guisp=#009dba
endif
hi! SignColumn cterm=NONE gui=NONE ctermfg=12 guifg=#839496 ctermbg=NONE guibg=NONE
hi! Conceal cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
...
hi! SpellLocal cterm=NONE,undercurl gui=NONE,undercurl ctermfg=NONE guifg=NONE ctermbg=NONE guibg=NONE guisp=#fea636
hi! Pmenu ctermfg=0 guifg=#073642 ctermbg=12 guibg=#839496 cterm=NONE,reverse gui=NONE,reverse
hi! PmenuSel ctermfg=11 guifg=#657b83 ctermbg=7 guibg=#ded3be cterm=NONE,reverse gui=NONE,reverse
...
if has('nvim')
  ...
  let g:terminal_color_2 = '#8c9d00'
  let g:terminal_color_3 = '#fea636'
  let g:terminal_color_4 = '#009dba'
...
hi! vimCommand cterm=NONE gui=NONE ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
hi! vimCmdSep cterm=NONE,bold gui=NONE,bold ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
...
hi! helpHyperTextJump cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! helpHyperTextEntry cterm=NONE gui=NONE ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE
hi! vimIsCommand cterm=NONE gui=NONE ctermfg=11 guifg=#657b83 ctermbg=NONE guibg=NONE
hi! vimSynMtchOpt cterm=NONE gui=NONE ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
hi! vimSynType cterm=NONE gui=NONE ctermfg=6 guifg=#2aa198 ctermbg=NONE guibg=NONE
hi! vimHiLink cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! vimHiGroup cterm=NONE gui=NONE ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! vimGroup cterm=NONE,bold gui=NONE,bold ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
...
hi! gitcommitUnmerged cterm=NONE,bold gui=NONE,bold ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE
...
hi! gitcommitSelectedType cterm=NONE gui=NONE ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE
...
hi! gitcommitSelectedFile cterm=NONE,bold gui=NONE,bold ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE
hi! gitcommitUnmergedFile cterm=NONE,bold gui=NONE,bold ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
...
hi! htmlTagName cterm=NONE,bold gui=NONE,bold ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! htmlSpecialTagName cterm=NONE gui=NONE,italic ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
hi! htmlArg cterm=NONE gui=NONE ctermfg=11 guifg=#657b83 ctermbg=NONE guibg=NONE
hi! javaScript cterm=NONE gui=NONE ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE
hi! perlHereDoc ctermfg=14 guifg=#93a1a1 ctermbg=8 guibg=#002b36 cterm=NONE gui=NONE
hi! perlVarPlain ctermfg=3 guifg=#fea636 ctermbg=8 guibg=#002b36 cterm=NONE gui=NONE
...
hi! texMathZoneX ctermfg=3 guifg=#fea636 ctermbg=8 guibg=#002b36 cterm=NONE gui=NONE
hi! texMathMatcher ctermfg=3 guifg=#fea636 ctermbg=8 guibg=#002b36 cterm=NONE gui=NONE
hi! texMathMatcher ctermfg=3 guifg=#fea636 ctermbg=8 guibg=#002b36 cterm=NONE gui=NONE
hi! texRefLabel ctermfg=3 guifg=#fea636 ctermbg=8 guibg=#002b36 cterm=NONE gui=NONE
...
hi! VarId ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! ConId ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
...
hi! hs_hlFunctionName ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE
...
hi! hs_OpFunctionName ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
...
hi! hsType ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! hsTypedef ctermfg=6 guifg=#2aa198 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! hsModuleName ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
...
hi! hsniceoperator ctermfg=6 guifg=#2aa198 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocTitleBlock ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocTitleBlockTitle ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocTitleComment ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocComment ctermfg=10 guifg=#586e75 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE,italic
hi! pandocVerbatimBlock ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! link pandocVerbatimBlockDeep pandocVerbatimBlock
hi! link pandocCodeBlock pandocVerbatimBlock
hi! link pandocCodeBlockDelim pandocVerbatimBlock
hi! pandocBlockQuote ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocBlockQuoteLeader1 ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocBlockQuoteLeader2 ctermfg=6 guifg=#2aa198 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocBlockQuoteLeader3 ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
...
hi! pandocTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocTableStructure ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! link pandocTableStructureTop pandocTableStructre
hi! link pandocTableStructureEnd pandocTableStructre
hi! pandocTableZebraLight ctermfg=4 guifg=#009dba ctermbg=8 guibg=#002b36 cterm=NONE gui=NONE
hi! pandocTableZebraDark ctermfg=4 guifg=#009dba ctermbg=0 guibg=#073642 cterm=NONE gui=NONE
hi! pandocEmphasisTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE,italic
hi! pandocEmphasisNestedTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocStrongEmphasisTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocStrongEmphasisNestedTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocStrongEmphasisEmphasisTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocStrikeoutTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,reverse gui=NONE,reverse
hi! pandocVerbatimInlineTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocSuperscriptTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocSubscriptTable ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocHeading ctermfg=9 guifg=#cb4b16 ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocHeadingMarker ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
...
hi! pandocLinkLabel ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocLinkText ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
...
hi! pandocLinkDefinitionID ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocImageCaption ctermfg=13 guifg=#6c71c4 ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocFootnoteLink ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocFootnoteDefLink ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocFootnoteInline ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocFootnote ctermfg=2 guifg=#8c9d00 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
...
hi! pandocVerbatimInline ctermfg=3 guifg=#fea636 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
...
hi! pandocRule ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
hi! pandocRuleLine ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
...
hi! pandocMetadata ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocMetadataKey ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
hi! pandocMetadata ctermfg=4 guifg=#009dba ctermbg=NONE guibg=NONE cterm=NONE,bold gui=NONE,bold
